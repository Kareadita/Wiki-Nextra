...
<Callout type="warning">
5/15/2026: AniList is experiencing severe API Degradation which is affecting Manga/LN metadata functions and rate limit issues. I am planning on a partial port to MangaBaka to restore functionalities, 
with the final coming with v0.9.1. Expect the release 5/17/2026.
</Callout>
...
<Callout type="info">
	Currently, only Manga/Light Novel/Comic metadata is supported. More Book-focused (and potentially comic) support is coming with [Hardcover](https://hardcover.app/) integration.
</Callout>
