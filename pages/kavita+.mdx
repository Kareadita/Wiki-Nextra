...
![User-Reviews](../public/kavita+/user-reviews.png "User-Reviews")
...
This can happen when you change hardware, OS, or re-install Kavita. Now in version 0.7.13.0 you can reset your own license by going to 
