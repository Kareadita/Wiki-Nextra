...
[Updating](installation/updating/updating-docker) - Instructions on how to update the Kavita server based on your install method. <br/>
...
[OPDS](guides/features/opds/) - Information on how the OPDS protocol works within Kavita. <br/>
...
[Kavita+](kavita+/) - All premium features of Kavita for those that support development monetarily. <br/>