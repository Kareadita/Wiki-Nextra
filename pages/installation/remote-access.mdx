...
<Callout type="info">
While we recgonize that most people want to access their system remotely, we do not provide an avenue for support. Any support requests based around remote access should be brought up with the vendor. 
</Callout>
...
<Tabs.Tab>
# VPN
If you plan to host your kavita for yourself and don't want to have public access to your server you should setup a vpn. 

Users usually recommend using [Zerotier](https://www.zerotier.com/) for this purpose. It's a free easy to setup vpn. Which doens't require any technical skill.
