...
Kavita is built with Microsoft .NET 8.0 and Angular 17. The .NET Framework requires an operating system that is still in it's support cycle in order to work. You can check the list of supported OS's [here](https://github.com/dotnet/core/blob/main/release-notes/8.0/supported-os.md)

Kavita can run on a wide varity of devices, but your experience will be better the more hardware resources you have. While your media files don't need to be on a SSD, keeping your Kavita database file on a SSD will greatly increase performance of the application. 
...
If you want to try out a demo of Kavita first before installing, you can find it on at [https://demo.kavitareader.com/](https://demo.kavitareader.com/login?apiKey=9003cf99-9213-4206-a787-af2fe4cc5f1f).
