...
If your QNAP device is capable of running docker, users have reported that the standard [docker install](/installation/docker/) works. This will enable you to stay up to date and even partake in nightly testing releases. 
