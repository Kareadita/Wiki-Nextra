...
If scoop was installed without modfying the default settings then Kavita will now be installed at `%userprofile%\scoop\apps\kavita\current\kavita.exe`
...
We reccomend using [shawl](https://github.com/mtkennerly/shawl) to run Kavita as a service. Shawl is a "portable app", you can simply download it and put it anywhere without going through an installer.
