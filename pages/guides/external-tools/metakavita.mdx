...
![MetaKavita Dashboard](https://raw.githubusercontent.com/raukorim-bot/MetaKavita/main/assets/dashboard.png)
...
* **Manga:** MangaDex, AniList, Kitsu, Shikimori, MangaBaka, MangaUpdates, Manga-News, MyAnimeList
* **Comics / BD:** ComicVine, Bédéthèque, BDTheque, Planète BD, Metron, League of Comic Geeks
* **Books:** Google Books, Open Library, Hardcover, Babelio, Decitre, SensCritique, Anime News Network
...
* **Inventory:** see which series are missing volumes or chapters, find likely duplicates, export CSV/TXT. Duplicate groups show Kavita folder paths and can generate a bash `mv`/`rm` script — MetaKavita never deletes files or Kavita records itself.
...
* **Light mode:** hide Manual Review, Inventory and/or volume enrichment from the sidebar if you do not use them.
...
services:
  metakavita:
    image: ghcr.io/raukorim-bot/metakavita:latest   # or pin :1.7
