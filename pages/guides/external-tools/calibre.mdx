...
To access polish you need to go to preferences > Toolbars & menus. From there you can choose the toolbar that fits best but the main toolbar is the one you'll likely be adding it to. 
Now on the left you'll see Available actions and on the right you'll see Current actions. Available actions are the plugins and options that are currently "hidden". You need to scroll through this list until you see Polish books. It'll have a little featherduster next to it. Click the green arrow pointing to the right to add it to Current actions. Now it should be at the bottom of the list and you can click on it then click the up and down arrows to the right to move it to the location you want it.

When you're done with that the button should appear on toolbar. Select a book or multiple then click on the button to pull up this screen.
