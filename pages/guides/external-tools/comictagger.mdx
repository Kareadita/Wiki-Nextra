...
### Notes
ComicTagger was originally written with Comic Vine solely in mind, it has since expanded to include a plug-in system, called talkers. There's now an ability to have many data sources, using the latest beta version and following their [installing a plugin](https://github.com/comictagger/comictagger/wiki/Installing-plugins) article and you'll find up to date data sources [here](https://github.com/comictagger/comictagger/wiki/Comic-and-Manga-Information-Sources).
