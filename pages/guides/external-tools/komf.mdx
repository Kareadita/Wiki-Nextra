...
Komf no longer works reliably with Kavita. The core app has not been updated in months and has issues that have not been addressed. Also the extension and the deprecated userscript have issues with the configuration icons appearing. The team is unaware of free alternatives for adding metadata into Kavita automatically.

[Kavita+](https://wiki.kavitareader.com/kavita+/metadata/) is getting a major overhaul in v0.9.1 with MangaBaka and Hardcover support, on top of ComicbookRoundup.

If you are aware of a software, please let us know.
</Callout>
