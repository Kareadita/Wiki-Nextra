...
If you are using a reverse proxy with Kavita, you can set this field so that Kavita uses your domain name. This will show up in users OPDS URL pages and any emails your server sends out, if configured to do so. 
