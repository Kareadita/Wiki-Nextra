...
The libraries tab is how you make your own content avilable to your users.

## Managing Libraries

![LibraryStatus](../../../public/guides/admin-settings/admin-settings-library-status.png "Library Status in Admin Settings")

Name of the library is highlighed in green. Clicking on it will send you to the series view inside the library.
...
Shared folders tells you how many source folders you have linked to this library. A single library can contain more than 1 folder on disk in order to merge libraries.

Last Scanned: Will give you the timestamp that the last scan occured. 
...
Using too large of a file here can slow down the server. 32x32 is reccomended
...
This controls what kind of files the scanner will look for when adding to the library. Use this for example if you want to turn off PDF's from showing up in a comic library. Or if your having cover.jpg's creating new series, you can turn off 'image'. 
...
<Callout type="info" emoji="ℹ️">
  This feature requires an active Kavita+ subscrtion to use. 
</Callout>
...
Overrides server folder watching for this library. If off, folder watching won't run on this library. If libraries share folders, then folders may still be ran against.

<Callout type="info" emoji="🐳">
  Docker on Windows over WSL2 does not support folder watching. [See Issue on Gihtuh](https://github.com/Kareadita/Kavita/issues/1714)
</Callout>
