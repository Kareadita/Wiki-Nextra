...
Comic (Legacy) has a similar presentation to the Manga library and is more versatile for those wishing to customize metadata to group series with singles/TPBs/Annuals all in one Kavita series.
