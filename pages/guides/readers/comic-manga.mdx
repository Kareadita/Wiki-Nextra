...
13. **Double Page Offset** - Offset page by 1 for Double Spread reading of Chapters (no cover image)

## Saving settings

See <Link href={`/guides/user-settings/reading-profiles`}>reading profiles</Link> for how saving happens. The following settings are **not** saved.
* Brightness
