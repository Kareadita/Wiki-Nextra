...
10. Paste your URL you copied into the 'host' field
11. Do NOT fill in username or password. Authentication is handled by your API key that is in your URL.
12. If your running kavita on a different port you need to remove the port 'IP:####' from your URL and add the port to the 'Port' setting.
