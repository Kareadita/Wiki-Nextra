...
## Known Limitations
* Recommendation and ReadingList features of Kavita currently are not supported.
* Tracking is supported, but as of Paperback v0.8 you must add the series to a collection (press the bookmark icon), then set up tracking individually.
...
4. Open Paperback and go back to the External Sources page and tap on Kayva
...
10. Enter your Auth key in the corresponding field.
12. Tap Save
...
## Progress Syncing
<Callout type="info">
    Progress Syncing is handled at the chapter/issue level, not the page level. That means after a chapter/issue is finished completion is synced to Kavita.
</Callout> 
