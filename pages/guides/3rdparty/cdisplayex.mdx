...
<Callout type="info">
	Connecting to Kavita from [CDisplayEx](https://www.cdisplayex.com/mobile/) requires the premium version of CDisplayEx!
</Callout>
...
Now press the **ADD** button and the synchronization will start, depending on the size of your library and the performance of your server
...
<Callout type="info">
To see a thumbnail on the folder and to display statistical information, you must activate the thumbnail option: [Show a thumbnail on folders](https://www.cdisplayex.com/mobile/settings/#show-a-thumbnail-on-folders)
</Callout>
