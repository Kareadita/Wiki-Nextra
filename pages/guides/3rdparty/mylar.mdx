...
This will tag your files according to [ComicVine](https://comicvine.gamespot.com/) where the volumes in are labeled as `Volume {VolumeYear}`. This is the best option since some volumes don't have proper volume numbers setup which causes volumes to stack and not show properly in the Kavita library.
