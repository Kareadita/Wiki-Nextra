...
To make the extension link with your Kavita instance we need the Auth Key.
The steps to get the Auth Key are:
...
3. Copy the text under the Auth Key

**Once the Auth KEY is obtained open Aidoku**

4. Go back to Browse page and tap on Kayva

5. Tap the "..." in the top right corner

6. Enter your Server URL and your Server Auth key and hit "Done"
