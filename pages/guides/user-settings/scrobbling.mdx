...
<Callout type="info">
   Scrobbling requires a [Kavita+](../../kavita+) subscription and your user account to have an API key saved in [Scrobbling Providers](account.mdx)
</Callout>
...
![ScrobblingHistory](../../../public/guides/user-settings/user-settings-scrobble.png)
