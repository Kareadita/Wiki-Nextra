...
### Comics Structure
<Callout type="info">
	 This part of the wiki is in progress. If you have schemes that work, please help by [submitting a PR](https://github.com/Kareadita/Wiki-Nextra/tree/main/pages/guides/scanner/pdf.mdx) or reach out to Kavita team in discord. We would love to enhance our documentation.
</Callout>  
