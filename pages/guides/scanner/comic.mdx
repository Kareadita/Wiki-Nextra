...
The "Comics" structure is the legacy parsing option that was used before the big comic overhaul and [Comic Vine](/guides/scanner/comicvine) library type was introduced. If you have metadata in your files and you are having issues with series combining when you don't want them to be, consider switching to the Comic Vine library type.
