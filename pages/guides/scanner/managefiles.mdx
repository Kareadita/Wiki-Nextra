...
## Editions
If a filename contains `Omnibus`, `Omnibus Edition`, or `Uncensored`, Kavita strips that phrase out into a separate Edition field rather than leaving it as part of the Series name.

```
To Love Ru v09 Uncensored (Ch.071-079).cbz
```
Parses as Series `To Love Ru`, Volume `9`, with Edition set to `Uncensored`.
