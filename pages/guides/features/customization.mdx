...
To access any customization in this section, you can click the actionable edit menu (&#8942;) from your side nav.
![access_customize](../../../public/guides/features/access_customize.png)

### Side Nav
Kavita also allows each user to customize their own Side Nav. Like with the Dashboard, you can reorder, and turn on/off side nav items, Smart Filters and External Sources. Side nav customizations are per-user. 
![customize_sidenav_final_config](../../../public/guides/features/customize_sidenav_final_config.png)
...
![sidenav_more_than_10](../../../public/guides/features/sidenav_more_than_10.png) 
...
![customize_dashboard_add_smartfilter](../../../public/guides/features/customize_dashboard_add_smartfilter.png)
![customize_dashboard_final_config](../../../public/guides/features/customize_dashboard_final_config.png)
![customize_dashboard_results](../../../public/guides/features/customize_dashboard_results.png)
...
![external_sources_add](../../../public/guides/features/external_sources_add.png)