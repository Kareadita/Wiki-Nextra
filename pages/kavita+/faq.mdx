...
This can happen when you change hardware, OS, or re-install Kavita. As of version 0.7.13.0 you can reset your own license by going to the [Kavita+ tab](../guides/admin-settings/kavita+.mdx)

#### I have a cool idea for Kavita+
Like all ideas with Kavita, please raise it on the [github features discussions](https://github.com/Kareadita/Kavita/discussions) and allow me and the community to expand on it and prioritize it. 
