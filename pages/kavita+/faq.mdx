...
This can happen when you change hardware, OS, or re-install Kavita. As of version v0.7.13, you can reset your license by going to the [Kavita+ tab](../guides/admin-settings/kavita+.mdx) and using the Reset button then Save to retie your server.
