...
Cover Image, if enabled, will do an additional check to avoid replacing a good cover with a lower resolution cover. 
Kavita will check if the cover is at least 70% similar and if so will take the file with the better resolution.
